const FALLBACK_CONTENT = `At Anil Chauhan Photography, we capture the essence of your most cherished moments
...
export default function DescriptionSection({ websiteContent }) {
  return (
    <section className="description-container">
      <div className="header">
        <h1>Anil Chauhan Photography</h1>
      </div>
      <div className="row">
        <div className="col-6 col-md-4 order-1 order-md-1">
          <div className="description-image-cover cover-1">
            <img src="/images/Description page/desc-2.webp" alt="Wedding couple portrait" />
          </div>
        </div>
        ...
        <div className="col-6 col-md-4 order-2 order-md-3">
          <div className="description-image-cover cover-2">
            <img src="/images/Description page/desc-1.webp" alt="Wedding celebration" />
          </div>
        </div>
      </div>
    </section>
