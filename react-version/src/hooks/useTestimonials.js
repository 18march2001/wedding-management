...
const FALLBACK_TESTIMONIALS = [
  { id: 1, name: 'Priya & Rahul Sharma', description: 'Choosing Anil Chauhan Photography was the best decision we made for our wedding. Every photo was a masterpiece, capturing our emotions and the spirit of our day perfectly.', photo_url: '/images/testimonials/testimonial_wedding.webp' },
  ...
  { id: 3, name: 'Aditi & Kunal Patel', description: "We couldn't be happier with the baby photos. Anil Chauhan Photography captured our little one's personality perfectly. These are memories we'll treasure forever.", photo_url: '/images/testimonials/testimonial_baby.webp' },
